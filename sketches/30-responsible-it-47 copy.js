...
function draw() {
  ...
  const cream = color(palette.blue);
  const red = ink(palette.orange, 125);
  const orange = ink(palette.rust, 135);
  const pink = ink(palette.blue, 175);
  const yellow = ink(palette.brown, 125);
  const blue = ink(palette.blue, 230);
  const green = ink(palette.blue, 195);
  const mint = ink(palette.blue, 215);
  const purple = ink(palette.ink, 120);
  const brown = ink(palette.clay, 105);
